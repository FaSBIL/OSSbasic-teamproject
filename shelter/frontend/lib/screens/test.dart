            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Wrap(
                    ...
                    children: [
                      ...
                      CustomIcon(
                        ...
                        isClickable: true,
                        borderRadius: 3.0,
                        onTap: () => _handleTap('arrowRight'),
                      ),
                      CustomIcon(
                        iconData: AppIcons.arrowLeft,
                        size: 24,
                        isClickable: true,
                        borderRadius: 3.0,
                        onTap: () => _handleTap('arrowLeft'),
                      ),
                      CustomIcon(
                  ...
                  SettingsNavItem(
                    label: '음성 안내 설정',
                    onTap: () => debugPrint('음성 안내 설정 클릭'),
                  ),
                  SettingsNavItem(
                    label: '백그라운드 실행',
                    onTap: () => debugPrint('백그라운드 실행 클릭'),
                  ),
                  SettingsNavItem(
                    label: '테마 모드',
                    onTap: () => debugPrint('테마 모드 클릭'),
                  ),
                  ...
                  FavoriteListItem(
                    title: "강남역 대피소",
                    address: "울특별시 강남구 강남대로 400...",
                  ),
                  const SizedBox(height: 23),
                  EvacuationSiteItem(
                    title: '대피소 이름23',
                    address: '주소 00000000000000000000',
                  ),
                  EvacuationSiteItem(
                    title: '서울특별시청 대피소',
